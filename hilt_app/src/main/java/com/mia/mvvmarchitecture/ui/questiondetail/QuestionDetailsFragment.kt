...
class QuestionDetailsFragment : BaseFragment(), QuestionDetailView.Listener,
    ...
    @Inject
    lateinit var mToastHelper: ToastHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionDetailViewModel = ViewModelProvider(this).get(QuestionDetailViewModel::class.java)
    ...
    override fun onCreateView(
        ...
        mView = mViewFactory.getQuestionDetailView(null)
