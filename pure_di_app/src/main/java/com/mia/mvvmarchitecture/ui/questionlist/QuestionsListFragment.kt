...
class QuestionsListFragment : BaseFragment(), QuestionsListView.Listener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionListViewModel = ViewModelProvider(
            this, mControllerCompositionRoot.getViewModelProviderFactory()
        ).get(QuestionListViewModel::class.java)

        mScreenNavigatior = mControllerCompositionRoot.getScreenNavigatior()
        mDialogsManager = mControllerCompositionRoot.getDialogsManager()
    ...
    override fun onCreateView(
        ...
        mQuestionsListView = mControllerCompositionRoot.getViewFactory().getQuestionsListView(null)
