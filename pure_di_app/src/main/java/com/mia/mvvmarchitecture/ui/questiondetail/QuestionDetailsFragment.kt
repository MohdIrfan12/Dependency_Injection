...
class QuestionDetailsFragment : BaseFragment(), QuestionDetailView.Listener,
    FragmentPermissionsHelper.Listener, QuestionDetailViewModelObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mToastHelper = mControllerCompositionRoot.getMessageDisplayer()
        mPermissionsHelper = mControllerCompositionRoot.getFragmentPermissionsHelper(this)

        mQuestionDetailViewModel = ViewModelProvider(
            this,
            mControllerCompositionRoot.getViewModelProviderFactory()
    ...
    override fun onCreateView(
        ...
        mView = mControllerCompositionRoot.getViewFactory().getQuestionDetailView(null)
